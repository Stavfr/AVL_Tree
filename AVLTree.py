...
class AVLTree(object):
    ...
    # O(logn)
    def find_parent_for_insert_theoretical_question_1(self, root, key, steps_counter):
        while root.is_real_node():
            root_key = root.get_key()
    ...
    def find_parent_for_insert_theoretical_question_1(self, key):
        ...
        parent_for_insertion, steps_counter = self.find_parent_for_insert_theoretical_question_1(
